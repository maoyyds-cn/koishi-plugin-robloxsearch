# koishi-plugin-smmcat-robloxservice

[![npm](https://img.shields.io/npm/v/koishi-plugin-smmcat-robloxservice?style=flat-square)](https://www.npmjs.com/package/koishi-plugin-smmcat-robloxservice)
...
`textAuditAppId` 和 `textAuditToken`，缺少审核配置时文本会按 fail-closed 策略遮罩。
